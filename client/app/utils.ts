...
export const courses = [
  ...
  { title: "Adults ", img: adults1, description: "Cualquier momento es bueno para empezar siempre que se tenga la decisión. No importa la edad ¿Querés viajar? ¿Querés mejorar tu vida laboral?", url: "/" },
]
