...
const Register = ({ onClose, toggleRegister, updateUser }: RegisterProps) => {
  ...
  return (
    <form
      className="md:w-1/3 relative min-h-[50vh] w-full  p-10 -mt-12 rounded-3xl backdrop-blur-3xl bg-white/20 shadow-black/30 shadow-xl z-50 overflow-y-auto"
